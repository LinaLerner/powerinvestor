...
solifap = Project.create(
  title: "Solifap",
  impact: "fas fa-male;3000 personnes relogées,fas fa-home;500 logements remis aux normes,fas fa-hammer;5 foyers construits",
...
bioburger = Project.create(
  ...
  impact: "fas fa-briefcase;25 jobs créés,fas fa-utensils;15 000 burgers bio livrés,fas fa-graduation-cap;16 écoles sensibilisées",
  provider: "Lita",
...
ecomegot = Project.create(
  title: "Ecomegot",
  impact: "fas fa-smoking;7 millions de mégots collectés,fas fa-male;3650 citoyens sensibi événements de sensisibilisation,fas fa-map-marker-alt;200 bornes solidaires installées",
