...
solifap = Project.create(
  ...
  start_date: DateTime.parse("08/01/2019 19:00"),
...
bioburger = Project.create(
  ...
  start_date: DateTime.parse("08/08/2019 19:00"),
  end_date: DateTime.parse("02/11/2019 19:00"),
...
ecomegot = Project.create(
  ...
  financial_product: "actions ordinaires",
  start_date: DateTime.parse("08/02/2019 19:00"),
  end_date: DateTime.parse("02/09/2019 19:00"),
...
terraliacorporate = Project.create(
  ...
  start_date: DateTime.parse("01/02/2019 19:00"),
  end_date: DateTime.parse("02/06/2019 19:00"),
